...
import com.huwo.data.upstream.api.biz.DuDriverStat;
 ...
 */
@Component
public class BaseInfoDriverStatStrategy extends IBasicAndOrderStrategy {
    ...
    private DuBasicQuality covertToDuBasicQuality(String ipcType, String channel, JSONObject jsonObject) {
        ...
        DuDriverStat stat = JSON.toJavaObject(jsonObject, DuDriverStat.class);
        basicQuality.setCertNo(stat.getLicenseId());
        return basicQuality;
    }
