...
import com.huwo.data.upstream.api.biz.DuDriverEducate;
...
@Component
public class BaseInfoDriverEducateStrategy extends IBasicAndOrderStrategy {
    ...
    private DuBasicQuality covertToDuBasicQuality(String ipcType, String channel, JSONObject jsonObject) {
        ...
        DuDriverEducate educate = JSON.toJavaObject(jsonObject, DuDriverEducate.class);
        basicQuality.setCertNo(educate.getLicenseId());
        basicQuality.setName(educate.getCourseName());
        return basicQuality;
    }
