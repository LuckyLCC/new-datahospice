...
import com.huwo.data.upstream.api.biz.DuRatedDriverPunish;
 ...
 */
@Component
public class RatedDriverPunishStrategy extends IBasicAndOrderStrategy {
    @Autowired
    ...
    private DuBasicQuality covertToDuBasicQuality(String ipcType, String channel, JSONObject jsonObject) {
        ...
        DuRatedDriverPunish punish = JSON.toJavaObject(jsonObject, DuRatedDriverPunish.class);
        basicQuality.setCertNo(punish.getLicenseId());
